...
<html lang="en">
<head>
    <title>Code coverage report for src/ciphers/FileCipher.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/ciphers</a> FileCipher.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import tweetncal from 'tweetnacl';
...
function createReadStreamFactoryInternal(getEncryptedStream, key, factOpts) {
  const blockMulitples = (factOpts &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >factOpts.blockMulitples)</span> || 16;
...
<span class="cstat-no" title="statement not covered" >    incrementNonce(nounce, 8);</span>
  }
}
&nbsp;
function incrementNonce(nonce, i = 0) {
  for (; i &lt; nonce.length; i++) {
    const digit = nonce[i];
    nonce[i] = digit + 1;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (nonce[i] &gt;= digit) {
      break;
    }
  }
}
