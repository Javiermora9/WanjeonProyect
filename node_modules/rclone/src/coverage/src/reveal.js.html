...
<html lang="en">
<head>
    <title>Code coverage report for src/reveal.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> reveal.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import AES from 'aes-js';
...
function atob2(data) {
  return typeof atob === 'function'
    ? atob(data)
    : <span class="branch-1 cbranch-no" title="branch not covered" >Buffer.from(data, 'base64').toString('binary');</span>
}
&nbsp;
