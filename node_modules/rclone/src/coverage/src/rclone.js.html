...
<html lang="en">
<head>
    <title>Code coverage report for src/rclone.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> rclone.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import scrypt from 'scrypt-js';
...
&nbsp;
function Rclone({ password, salt } = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> {
...
function fromKeys(keys) {
  ...
  function <span class="fstat-no" title="function not covered" >createReadStreamFactory(</span>createReadStream) {
<span class="cstat-no" title="statement not covered" >    return createReadStreamFactoryInternal(createReadStream, keys.dataKey);</span>
  }
&nbsp;
...
function generateKeys(encPass, encSalt, callback) {
  ...
  if (password.length === 0) {
    ...
    scrypt(password, salt, 16384, 8, 1, keySize, (error, progress, key) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (error) <span class="cstat-no" title="statement not covered" >callback(error, null);</span>
      if (key) {
